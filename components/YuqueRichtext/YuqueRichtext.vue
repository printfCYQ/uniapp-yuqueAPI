<template>
	<view>
		<rich-text v-if="richtext" :nodes="richtext"></rich-text>
	</view>
</template>
...
<style>
	.ne-codeblock.language-html,
	.ne-codeblock.language-css,
	.ne-codeblock.language-vue,
	.ne-codeblock.language-Typescript,
